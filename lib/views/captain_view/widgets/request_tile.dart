                ...
                children: [
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: CachedNetworkImageProvider(
                          data.userId?.image?.s64px ?? dummyNetImg,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text.rich(TextSpan(text: data.min ?? '', style: TextStyle(color: KColors.of(context).reBackground), children: <InlineSpan>[
                        TextSpan(
                            text: data.tripRoads!.isNotEmpty
                                ? ' ${LocationHelper.getDistance(lat2: double.parse(data.tripRoads?.first.latitude ?? ''), lon2: double.parse(data.tripRoads?.first.longitude ?? '')).toStringAsFixed(3)}km'
                                : '',
